USE [Position_DB]
GO
/****** Object:  Table [RWA].[SecuCCR_Netting]    Script Date: 2016/2/24 16:18:18 ******/
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [RWA].[SecuCCR_Netting](
	[ID] [int] NOT NULL,
	...
	[期限调整] [decimal](28, 10) NULL,
	[预期损失] [decimal](28, 10) NULL,
	[非预期损失] [decimal](28, 10) NULL,
	[净敞口风险权重] [decimal](28, 10) NULL,
 ...
 CONSTRAINT [PK_SecuCCR_Netting] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
