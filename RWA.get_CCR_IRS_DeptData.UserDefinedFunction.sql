USE [Position_DB]
GO
/****** Object:  UserDefinedFunction [RWA].[get_CCR_IRS_DeptData]    Script Date: 2016/2/24 11:16:44 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE FUNCTION [RWA].[get_CCR_IRS_DeptData]
( 
...
left join	
(	
	select  Balance_date,DeptId as 账户范围,[部门#] as 识别码,SecuCode,Settleday,固定利率,年付次数,Notional,曲线代码
